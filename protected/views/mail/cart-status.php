                    ...
                    <div style="max-width:600px;display:block;border-collapse:collapse;margin:0 auto;padding:30px 15px;border:1px solid #e7e7e7">
                        <table bgcolor="transparent" style="max-width:100%;border-collapse:collapse;border-spacing:0;width:100%;background-color:transparent;margin:0;padding:0">
                            <tbody>
                                <tr style="margin:0;padding:0">
                                    <td style="margin:0;padding:0">
                                        <?php if ($model->order_status_id == 2): ?>
                                        <h5 style="line-height:24px;color:#000;font-weight:900;font-size:17px;margin:0 0 20px;padding:0">Terima kasih atas konfirmasi pembayaran yang telah Anda lakukan... no order <?php echo $modelOrder->invoice_prefix.'-'.$modelOrder->invoice_no ?> akan segera kami kirimkan. Terima Kasih</h5>
                                        <?php elseif($model->order_status_id == 3): ?>
                                        <h5 style="line-height:24px;color:#000;font-weight:900;font-size:17px;margin:0 0 20px;padding:0">Terima kasih atas konfirmasi pembayaran yang telah Anda lakukan... no order <?php echo $modelOrder->invoice_prefix.'-'.$modelOrder->invoice_no ?> dalam proses pengiriman. Terima Kasih</h5>
                                        <?php else: ?>
                                        <h5 style="line-height:24px;color:#000;font-weight:900;font-size:17px;margin:0 0 20px;padding:0">Status pesanan anda saat ini "<?php echo $statusStr ?>"<?php //echo Yii::t('mail', 'Pesanan anda telah kami terima, kami akan menghubungi anda untuk biaya pengiriman dan total transfer') ?></h5>
                                        <?php endif ?>
                                        <?php /*
                                ...
                                <tr style="margin:0;padding:0">
                                    ...
                                    */ ?>
                                    ...
                                    <td valign="middle" style="width:40%">
                                        ...
                                        <div style="text-align:right"><img alt="<?php echo Yii::app()->name; ?>" style="max-width: 120px;" src="<?php echo $baseUrl ?>/asset/images/lgo-header-ufo.png">
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
