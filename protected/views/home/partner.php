        ...
        <div class="row">
            <div class="col-md-60">
                <div class="box-content">
                    ...
                    <div class="subtitle">
                        <p>Reich invites you to join our successful sales plan, and let’s grow it together. Whether you are an interior furniture maket, a contractor or furnishing industry applicator, an architect, or professional consultant for buildings and interiors, we have so many business models that you can take benefits from to your side.</p>
                    </div>
                    <div class="caption">
            ...
            <div class="col-md-30">
                <div class="box-content">
                    <div class="image-kiri">
                        <img class="img img-fluid w-100" src="<?php echo $this->assetBaseurl; ?>partnersec1.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-30">
    ...
    <div class="prelative container">
        <div class="row">
            ...
            <div class="col-md-30">
                <div class="box-content-kanan">
                    <div class="image">
                        <img class="img img-fluid w-100" src="<?php echo $this->assetBaseurl; ?>partnersec2.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="prelative container">
        <div class="row">
            <div class="col-md-60">
                <div class="box-content">
                    <div class="title">
                        <p>Non stop support to our partner</p>
                    </div>
                    <div class="subtitle">
                        <p>Product perfection is only half the battle. Through multiple support, plans and strategies, Reich’s marketing team will help you run and penetrate your target market right from the product introduction to product usage continuity.</p>
                    </div>
                </div>
            </div>
        </div>
