        ...
        <div class="row">
            <div class="col-sm-2 containersub-blog-list">
                ...
                <ul class="list-unstyled list-left-menu">
                    <li><a href="<?php echo CHtml::normalizeUrl(array('/home/index')); ?>">ON THE SPOTLIGHT</a></li>
                    <li><a href="<?php echo CHtml::normalizeUrl(array('/home/index')); ?>">FASHION GUIDE</a></li>
                    <li><a href="<?php echo CHtml::normalizeUrl(array('/home/index')); ?>">BEAUTY TIPS</a></li>
                    <li><a href="<?php echo CHtml::normalizeUrl(array('/home/index')); ?>">BEAUTY STARS</a></li>
            ...
            <div class="col-sm-10">
                ...
                <h1 class="title-blog">Bagaimana tampil sederhana, namun tetap “Fabulous” seperti Chelsea Islan</h1>
                <div class="height-20"></div>
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="height-20"></div>
                <div class="blog-teks">
                    <img src="<?php echo Yii::app()->baseUrl ?>/images/blog/blog-image-1.jpg" alt="" align="right">
                ...
                <p style="text-align: center;">
                    <a class="button-border-black" href="<?php echo CHtml::normalizeUrl(array('home/index')); ?>">LOAD MORE ARTICLE</a>
                </p>
...
Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non magnam temporibus in excepturi aliquam, accusamus quis. Aspernatur vel mollitia nisi repellat illum, porro amet, dolores recusandae debitis reprehenderit harum ipsam aliquid odio, culpa tempore aut eum voluptatum. Reiciendis, quibusdam libero?