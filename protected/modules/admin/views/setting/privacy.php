	...
	<?php foreach ($model as $key => $value): ?>
		...
		<div class="control-group ">
			...
			<div class="controls">
				...
				<?php elseif ($value['data']->type=='image'): ?>
				<?php echo CHtml::fileField('Setting['.$value['data']->name.']', $value['data']->value) ?>
					<div class="clearfix"></div>
					<div style="height: 10px;"></div>
					<img class="img-polaroid" src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(198,150, '/images/static/'.$value['data']->value , array('method' => 'adaptiveResize', 'quality' => '90')) ?>" alt="">
				<?php else: ?>
