...
<div class="widget">
<h4 class="widgettitle">Data Faq</h4>
	...
	<div class="multilang pj-form-langbar">
		...
		<?php Yii::import('ext.imperavi-redactor-widget.ImperaviRedactorWidget'); ?>
			...
			foreach ($modelDesc as $key => $value) {
				...
				<?php
				echo $form->labelEx($value, '['.$lang->code.']question');
			    echo $form->textField($value,'['.$lang->code.']question',array('class'=>'span11', 'maxlength'=>100));
			    ?>
				...
				<?php
				echo $form->labelEx($value, '['.$lang->code.']answer');
			    echo $form->textArea($value,'['.$lang->code.']answer',array('class'=>'span5 redactor', 'maxlength'=>100));
			    ?>
			    <span class="pj-multilang-input"><img src="<?php echo Yii::app()->baseUrl.'/asset/backend/language/'.$lang->code.'.png' ?>"></span>
			    <span class="help-inline _em_" style="display: none;">Please correct the error</span>
				</div>
