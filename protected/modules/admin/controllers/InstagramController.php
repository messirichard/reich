...
class InstagramController extends ControllerAdmin
{
	/**
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Instagram'];
	...
	{
		$model=new Instagram('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Instagram']))
			$model->attributes=$_GET['Instagram'];
	...
	{
		$model=Instagram::model()->findByPk($id);
		if($model===null)
