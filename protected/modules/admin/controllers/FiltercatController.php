...
class FiltercatController extends ControllerAdmin
{
	public $type = 'filtercat';
	/**
	...
	public function actionCreate()
	{
		...
		$nestedCategory = PrdCategory::model()->nested($dataNestedCategory['data'], 'filtercat');
